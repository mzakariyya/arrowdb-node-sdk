...
function createArrowDBRequestFunction(options) {
	...
	return function (restOptions, callback) {
		...
		function prepareArrowDBRequest() {
			...
			arrowDBRequest(apiEntryPoint, this.appOptions, this.arrowDBMethod, options.httpMethod, this.sessionCookieString, restOptions, function (error, result) {
